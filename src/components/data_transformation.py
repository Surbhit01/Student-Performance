...
class DataTransformation:
    ...
    def get_data_transformer_obj(self):
        try:
            ...
            logging.info('Column Transformer Pipeline created')
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            preprocessed_input_feature_train = preprocessor_obj.fit_transform(input_feature_train_df)
            preprocessed_input_feature_test = preprocessor_obj.transform(input_feature_test_df)
